...
public class ItemRegistry
{
    ...
    //Items
    public static final RegistryObject<Item> ENDER_ARM = register("ender_arm", () -> new EnderArmItem(new Item.Properties().durability(EnderarmConfig.GENERAL.armDurability.get()).tab(ItemGroup.TAB_TOOLS).rarity(Rarity.EPIC)));
